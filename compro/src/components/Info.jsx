  ...
  return (
    <section ref={sectionRef} id="info" className="bg-gray-50 text-gray-800 py-20 px-6 md:px-12 lg:px-20 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Info Cards - Staggered fade in from bottom */}
        <div className="grid md:grid-cols-3 gap-8">
          {infoCards.map((card, i) => (
            ...
            >
              ...
              <a href="#" className="text-[#e83136] font-medium hover:underline text-sm inline-flex items-center gap-1 transition-all duration-300 hover:gap-2 hover:text-[#cc262b]">
                {card.link}
              </a>
            </div>
          ))}
